...
import { ArrowRight, Users, MessageSquare, Handshake, Zap } from "lucide-react";
import { useScrollAnimation } from "@/hooks/useScrollAnimation";
import heroImg from "@/assets/service-hero-tcb.jpg";

const solutions = [
  { icon: Users, title: "High-Performing Team Workshops", description: "Facilitated sessions that build trust, clarify roles, and establish team norms for sustained high performance." },
  { icon: MessageSquare, title: "Communication & Feedback Culture", description: "Training programmes that develop psychological safety, constructive feedback habits, and transparent communication practices." },
  { icon: Handshake, title: "Cross-Functional Collaboration", description: "Break down silos with structured collaboration frameworks, shared OKRs, and inter-departmental alignment programmes." },
  { icon: Zap, title: "Agile Team Dynamics", description: "Equip teams with agile ways of working, sprint methodologies, and continuous improvement practices for faster delivery." },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-28">
          ...
          <motion.p className="text-[18px] md:text-[20px] text-muted-foreground leading-[1.6] max-w-2xl" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
            Transform groups into high-performing teams. We build the trust, communication, and collaboration skills that drive exceptional results.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 bg-cap-blue text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-[24px] font-bold mb-4 text-primary-foreground">Build teams that deliver extraordinary results</h2>
