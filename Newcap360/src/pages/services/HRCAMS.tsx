...
import { ArrowRight, Shield,Settings, Users, BarChart3, Building2, Award, ChevronLeft, ChevronRight, Check, CheckCircle2,
  TrendingUp,
  Target,
  Zap,
  Brain,
...
const stats = [
  ...
  { value: "98%", desc: "compliance accuracy achieved across managed HR operations" },
...
const HRCAMS = () => {
      ...
      for (const slot of [left, right]) {
        if (slot === "card") {
          if (cardIdx < subServices.length) {
            row.push({ type: "card", item: subServices[cardIdx], index: cardIdx });
            cardIdx++;
          }
        } else {
  ...
  const stats = [
              ...
              { value: "3x", desc: "faster hiring turnaround achieved through optimized talent acquisition strategies" },
...
const phases = [
  ...
  <div className="container mx-auto px-4 lg:px-8">
    ...
    >
      <div className="mb-10">
        <p className="text-sm text-cap-orange tracking-wide mb-2">ABOUT HRCAMS</p>
        <h2 className="text-[32px] md:text-[42px] font-bold leading-tight">
          Transforming HR Into a<span className="text-cap-orange"> Strategic Growth Engine</span>
        </h2>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div className="border-l-2 border-cap-orange/40 pl-6">
          <p className="text-[18px] text-muted-foreground leading-[1.8]">
            <span className="text-foreground font-medium">HRCAMS</span> (HR Capability & Managed Services)
            is designed to help organizations move beyond traditional HR operations and build
            <span className="text-foreground font-medium"> future-ready, high-impact people functions</span>.
          </p>
        </div>

        <div className="border-l-2 border-cap-orange/40 pl-6">
          <p className="text-[18px] text-muted-foreground leading-[1.8]">
            We go beyond tools—partnering with organizations to assess, design, and transform HR capabilities,
            powered by a Global Capability Center delivering continuous support, innovation, and measurable business outcomes.
          </p>
        </div>
      </div>
      ...
      <section id="services" className="py-24" ref={servicesRef}>
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <p className="text-[16px] text-muted-foreground mb-14 max-w-2xl">
            Six integrated service lines designed to transform every dimension of your HR function. Each service line is modular yet interconnected—choose one solution or combine multiple lines for comprehensive transformation.
          </p>
            ...
            {mosaicRows.map((row, rowIdx) => (
              ...
              >
                {row.map((cell, colIdx) => {
                  ...
                  if (cell.type === "image") {
                    return (
                      <div
                        ...
                        style={{ height: 240, overflow: "hidden", background: "#111" }}
                      >
                        <img
                          src={cell.src}
                          alt="service visual"
                  ...
                  const s = cell.item;
                  const accentColors = [
                    "bg-cap-blue", "bg-cap-orange", "bg-cap-green",
        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          >
            ...
            <p className="text-[18px] text-muted-foreground leading-relaxed">
             Every engagement begins with understanding your unique challenges and goals. We follow a structured approach to deliver transformation.
            </p>
          </motion.div>
  ...
  <div className="container mx-auto px-4 lg:px-8 grid lg:grid-cols-2 gap-16 items-start">
    ...
    <div className="lg:sticky top-18 h-fit">
      ...
      >
        From fast-scaling startups to complex enterprises, we partner with organizations navigating growth, transformation, and workforce complexity.
      </motion.p>
      ...
      >
        <p className="text-[17px] text-foreground font-medium">
          We don’t just support HR — we enable business scalability through structured workforce models.
        </p>
      </motion.div>
    </div>
      ...
      <section id="founder" className="py-24 section-navy relative overflow-hidden">
        ...
        <div className="w-full px-6 lg:px-16 xl:px-24 relative z-10">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={leadersInView ? { opacity: 1, y: 0 } : {}} ref={leadersRef} className="mb-16">
            <h2 className="text-[32px] md:text-[42px] font-bold mb-2">Meet Our Leader</h2>
            <p className="text-[18px] text-muted-foreground">37+ years of corporate leadership and strategic HR expertise | Chief of Staff-level strategic partner to CEOs | AI-Enabled HR Transformation Specialist</p>
          </motion.div>
          <motion.div className="max-w-8xl" initial={{ opacity: 0, y: 30 }} animate={leadersInView ? { opacity: 1, y: 0 } : {}} transition={{ delay: 0.2 }}>
            <div className="grid md:grid-cols-3 gap-8 items-center">
              <div className="md:col-span-1">
                <div className="w-full max-w-sm mx-auto aspect-square rounded-xl overflow-hidden border border-border/40">
                  <img src={card1} alt="Shivinder Mandhotra" className="object-cover w-full h-full" />
                </div>
              </div>
              <div className="md:col-span-2">
                <h3 className="text-[28px] font-bold mb-2">Radhakrishnan K V</h3>
                <p className="text-cap-orange font-semibold text-[14px] mb-6 uppercase tracking-wider">Leader</p>
                <div className="space-y-6 mb-8">
                  <p className="text-[17px] text-muted-foreground leading-[1.8]">
                     Spent 37+ years with NIIT Group, most recently as SVP – HR & Special Projects, partnering with leadership across 5,000+ employees in India, US, Europe, and China. Drove enterprise transformation, performance management, compensation strategy, and HR technology initiatives.                  </p>
                  {/* <p className="text-[17px] text-muted-foreground leading-[1.8]">
                ...
                <div className="grid sm:grid-cols-2 gap-4 mb-8">
                  {[
                    { title: "Strategy & Organization", sub: "Translating strategic intent into operating models and decision frameworks" },
                    { title: "AI-Enabled HR Solutions", sub: "Pragmatic AI applications for process simplification and decision-making" },
                    { title: "NIIT", sub: "Professional Diploma in Network Centered Computing " },
                ...
                <button className="bg-cap-orange text-background px-6 py-3 font-semibold hover:bg-cap-orange/90 transition-all rounded-md inline-flex items-center gap-2">
                  Schedule with Radhakrishnan K V <ArrowRight className="w-4 h-4" />
                </button>
              </div>
            </div>
          </motion.div>
