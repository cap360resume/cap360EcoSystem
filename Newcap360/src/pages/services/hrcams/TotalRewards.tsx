...
import visionTR from "@/assets/VisionTR.png"
...
const TotalRewards = () => {
  ...
  const solutions = [
      ...
      content: (
        <>
          ...
          <ul className="space-y-3 mb-4 list-disc pl-5">
            <li>
              <strong>Grade and band design:</strong> Creating a levelled
              structure (e.g., L1–L8 or Band A–F) that brings consistency to
              titling, pay ranges, and progression paths across functions.
            </li>
            <li>
              <strong>Internal parity modelling:</strong> Identifying and
              correcting pay inequities before they become attrition risks or
              compliance issues.
            </li>
            <li>
              <strong>Pay mix optimisation:</strong> Structuring the right
              balance of fixed pay, performance-linked variable, and long-term
              incentives based on role criticality, industry benchmarks, and
              organisational philosophy.
            </li>
            <li>
              <strong>Compensation governance frameworks:</strong> Defining
              approval authorities, revision cycles, and documentation standards
              so decisions remain consistent, transparent, and auditable.
            </li>
          </ul>

          <p>
            The outcome is a structured, equitable, and scalable compensation
            system that supports talent attraction, retention, and
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ul className="space-y-3 mb-4 list-disc pl-5">
            <li>
              <strong>Performance-linked variable models:</strong> Defining
              clear payout formulae tied to individual KPI achievement and
              business performance thresholds.
            </li>
            <li>
              <strong>Target-setting methodology:</strong> Structuring goals
              that are ambitious yet achievable — avoiding the “all or nothing”
              effect and sustaining motivation.
            </li>
            <li>
              <strong>Sales incentive architecture:</strong> Designing incentive
              structures for sales roles, including accelerators, decelerators,
              and territory fairness mechanisms.
            </li>
            <li>
              <strong>Profit-linked incentive models:</strong> Enabling
              organisations to share value creation with employees in a
              structured and sustainable way.
            </li>
          </ul>

          <p>
            The outcome is a high-impact incentive system that reinforces
            performance, drives accountability, and directly links rewards to
            business success.
          </p>
        </>
      ),
...

    {
      icon: Target,
      title:
        "Long-Term Incentive (LTI) Models — ESOPs, Phantom Stock & SAR Advisory",
      content: (
        <>
          <p className="mb-4">
          ...
          <ul className="space-y-3 mb-4 list-disc pl-5">
            <li>
              <strong>ESOP design:</strong> Structuring Employee Stock Option
              Plans including eligibility criteria, grant sizing, vesting
              schedules (typically 3–4 year cliff and graded), exercise pricing,
              and exit event provisions.
            </li>
            <li>
              <strong>Phantom stock & Stock Appreciation Rights (SARs):</strong>{" "}
              For private companies not ready for ESOPs, these models provide
              economic upside without diluting the cap table.
            </li>
            <li>
              <strong>Vesting design & governance:</strong> Aligning vesting
              timelines, acceleration clauses, and governance frameworks with
              PE/VC investment structures and potential IPO pathways.
            </li>
          </ul>

          <p>
            The result is a robust long-term incentive strategy that strengthens
            leadership retention, aligns interests with enterprise value
            creation, and supports sustainable organisational growth.
          </p>
        </>
      ),
    },

    {
      ...
      content: (
        <>
          ...
          <ul className="space-y-3 mb-4 list-disc pl-5">
            <li>
              <strong>Spot awards & peer recognition programmes:</strong>{" "}
              Enabling timely appreciation of contributions through structured
              and inclusive recognition mechanisms.
            </li>
            <li>
              <strong>Behaviour-linked recognition:</strong> Aligning
              recognition programmes with organisational values to reinforce the
              behaviours that matter most.
            </li>
            <li>
              <strong>Budget discipline models:</strong> Designing
              cost-effective frameworks that ensure scalability without
              compromising impact.
            </li>
            <li>
              <strong>Manager toolkits:</strong> Equipping managers with
              practical tools and guidelines to deliver meaningful and
...

    {
      ...
      content: (
        <>
          ...
          <ul className="space-y-3 mb-4 list-disc pl-5">
            <li>
              <strong>Group health & term insurance structuring:</strong>{" "}
              Advisory on designing comprehensive coverage plans that balance
              employee needs with organisational cost considerations.
            </li>
            <li>
              <strong>Flexible benefits architecture:</strong> Creating modular
              benefits programmes tailored to different employee segments and
              life stages.
            </li>
            <li>
              <strong>Leadership wellbeing frameworks:</strong> Designing
              wellbeing and executive benefit structures that support senior
              leadership performance and sustainability.
            </li>
            <li>
              <strong>Leave & flexibility policy design:</strong> Aligning
              leave, remote work, and flexibility policies with talent strategy
              and organisational culture.
            </li>
          </ul>

          <p>
            The result is a future-ready benefits ecosystem that enhances
            employee experience, strengthens employer brand, and supports
  ...
  const cards = [
    {
      ...
      title: "Enhanced employee value proposition",
      desc: "Attract and retain top talent through competitive, well-structured compensation, benefits, and rewards that strengthen employee engagement and employer brand.",
    },
    {
      icon: <Cog className="w-12 h-12 text-orange-500 mb-6" />,
      title: "Cost efficiency & pay optimisation",
      desc: "Design balanced fixed–variable pay structures that optimise costs while ensuring performance-driven payouts and sustainable compensation models.",
    },
    {
      icon: <Users className="w-12 h-12 text-orange-500 mb-6" />,
      title: "Performance-linked rewards",
      desc: "Drive a high-performance culture through structured STI/LTI models and incentive frameworks that directly align rewards with business outcomes.",
    },
    {
      icon: <BarChart3 className="w-12 h-12 text-orange-500 mb-6" />,
      title: "Data-driven reward decisions",
      desc: "Leverage benchmarking, analytics, and internal equity frameworks to ensure fair, competitive, and insight-led compensation decisions.",
    },
    {
      icon: <TrendingUp className="w-12 h-12 text-orange-500 mb-6" />,
      title: "Scalable & future-ready rewards",
      desc: "Build flexible total rewards architectures including ESOPs, benefits, and wellbeing programs that scale with business growth while maintaining governance.",
    },
  ];
      ...
      <section className="bg-black text-white py-24 px-6 lg:px-16 " ref={bRef}>
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-start">
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, delay: 0.2 }}
            className="bg-orange-500 p-10 lg:p-12"
          >
            <div className="text-sm font-semibold tracking-wide uppercase text-gray-300 mb-4">
              DATA
            </div>

            <div className="text-[64px] font-bold mb-6">69%</div>

            <p className="text-gray-200 leading-relaxed">
              of employees prioritise compensation and benefits when choosing or
              staying with an employer—making total rewards a key driver of
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16">
            <h2 className="text-[28px] md:text-[36px] lg:text-[44px] font-bold leading-[1.1]">
              How vision, strategy and execution are reshaping <br /> Total
              Rewards
            </h2>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="max-w-md ml-auto">
              ...
              <h3 className="text-lg md:text-xl font-semibold mb-6">
                Build a future-ready rewards architecture
              </h3>

              <p className="text-base md:text-lg text-gray-300 leading-relaxed">
                Total rewards today go beyond compensation—they are strategic
                levers for attracting, motivating, and retaining talent. Through
                structured compensation design, STI/LTI models, ESOP advisory,
                and holistic benefits frameworks, organisations can create a
                high-performance culture while maintaining cost efficiency and
