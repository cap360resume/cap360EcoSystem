...
import { ArrowRight, Shield, FileCheck, Scale, AlertTriangle } from "lucide-react";
...
const LabourLaw = () => {
  ...
  const solutions = [
    { icon: Scale, title: "Labour Law Compliance Audits", description: "End-to-end compliance audits covering all central and state labour laws, identifying gaps and providing actionable remediation roadmaps." },
    { icon: Shield, title: "HR Policy & Governance Framework", description: "Design and implement robust HR policies, codes of conduct, POSH frameworks, and governance structures aligned with regulatory requirements." },
    { icon: FileCheck, title: "Statutory Compliance Management", description: "Managed services for PF, ESI, gratuity, bonus, minimum wages, and other statutory obligations with automated tracking and filing." },
    { icon: AlertTriangle, title: "Risk Assessment & Mitigation", description: "Proactive identification of compliance risks with mitigation strategies, training, and ongoing monitoring for continuous compliance." },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-[50vh] flex items-center bg-cap-navy overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 lg:px-8 py-28">
          ...
          <motion.p className="text-lg text-foreground/80 leading-relaxed max-w-2xl" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
            Navigate the complex regulatory landscape with confidence. Our compliance experts ensure your organization stays ahead of evolving labour laws.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16 bg-cap-blue text-center">
        <div className="container mx-auto px-4">
          <h2 className="text-2xl font-bold mb-4 text-primary-foreground">Ensure 100% compliance with confidence</h2>
          <a href="#" className="inline-flex items-center gap-2 bg-foreground text-background px-8 py-4 font-semibold hover:gap-3 transition-all">Talk to compliance experts <ArrowRight className="w-5 h-5" /></a>
        </div>
      </section>
      <Footer />
    </div>
